...
void loop()
{
    ...
    Serial.printf("got %d points in %lu ms. Frame Processing in %lu. Frame publishing in %lu. Total loop in %lu ms. Freq=%.1f Hz Serial1.available=%d\r\n",
                  count, uart_elapsed, process_elapsed, publish_elapsed, total_loop_time, 1000.0 / loop_period, Serial1.available());
...
//     Serial1.begin(460800, SERIAL_8N1, 16, 17); // GPIO16 = RX, GPIO17 = TX
//     Serial.println("Serial1 started. Sending RPLIDAR reset command...");
